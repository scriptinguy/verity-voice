...
# 1. In-memory audio caching to prevent burning credits on duplicate lines
AUDIO_CACHE = {}

class TTSRequest(BaseModel):
    text: str
    reference_id: str | None = None
    model: str = "s2.1-pro-free"  # Free developer model default
...
async def generate_tts(data: TTSRequest):
    ...
    # 2. Crucial: "model" MUST be inside the headers dict for Fish Audio free tier routing
    headers = {
